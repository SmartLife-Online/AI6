...
| `AI6_TICKET_VALIDATION_PROFILE` | `generic_v1` | serverseitig allowlistetes Ticketvalidierungsprofil (`generic_v1` oder `ai6_detail_v1`); Repositoryinhalt kann es nicht setzen |
