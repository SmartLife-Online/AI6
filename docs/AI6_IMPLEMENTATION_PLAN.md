...
18. AI6-012 — Ticketprüfung, Approval-Snapshot und Multi-Reviewer-Auswahl
19. AI6-013 — Run-State-Machine, Persistenz und Projektsperre
20. AI6-014 — Run-Branch, Worktree, Checkpoint und Diff-Service
21. AI6-015 — ProcessRunner, ExecutionMailbox und Prozessgrenzen
22. AI6-016 — JSON-Verträge und FakeAgent
23. AI6-017 — Basisschritt-Orchestrator und Run-Timeline
24. AI6-018 — Human Requests, E-Mail, Attention-Inbox und Resume
25. AI6-019 — Implementierungsagent-Turn und sicherer Diff-Import
26. AI6-020 — Adaptive Scope- und Vertragsänderungen
27. AI6-021 — Checkprofile und credentialfreier Checker
28. AI6-022 — Pre-Review-Verifikation und Checkpoint-Bereitschaft
29. AI6-023 — Read-only Review-Workspaces und Multi-Reviewer-Ausführung
...
- Ungültige Tickets sind mit strukturierten Fehlern lesbar und bei `redaction_state=none` reparierbar, aber nicht approvable oder startbar; `unparsed` zeigt nur den Envelope/Refreshzustand.
...
- Editorfreigabe ausschließlich aus `document_state=invalid|valid` und `redaction_state=none`; eine maskierte oder `unparsed` Projektion kann weder geladen noch zurückserialisiert werden.
...
- Worker prüft unmittelbar vor Mutation erneut unveränderten Blob, `redaction_state=none` und exakten unmaskierten Editor-Base-Inhalt; kein maskierter Marker gelangt in Git.
...
- Approvalquelle ausschließlich aus einem frischen Read Model mit `document_state=valid`, `redaction_state=none` und vorhandenem Contract-Hash; `unparsed`, `invalid`, `content_redacted`, stale Bindung oder fehlgeschlagene erneute Worker-Validierung sperren die Aktion technisch.
...
- Approval verlangt `document_state=valid`, `redaction_state=none`, den unveränderten erwarteten Blob-SHA, vorhandenen Contract-Hash und eine erneute Worker-Validierung; eine ungültige oder maskierte Projektion kann weder bestätigt noch als unveränderte Vollansicht ausgegeben werden.
...
Die bisherigen statischen Browserprompts werden nicht übernommen. Neue zentrale Templates folgen diesen Regeln:
