...
|---|---|
| Gegen den realen Repositoryzustand abgeleitet oder rebased | AI6-001, AI6-002, AI6-003, AI6-004, AI6-005A, AI6-005B, AI6-006A, AI6-006B, AI6-006C, AI6-006D, AI6-006E, AI6-007, AI6-008, AI6-009, AI6-010, AI6-011 |
| Gegen den erwarteten Zustand nach den Vorgängertickets abgeleitet | AI6-006F, AI6-044, AI6-012, AI6-013, AI6-014, AI6-015, AI6-016, AI6-017 |
...
`AI6-012`, `AI6-013`, `AI6-014`, `AI6-015`, `AI6-016` und `AI6-017` wurden am 13. August 2026 auf ausdrückliche menschliche Anordnung vor der Umsetzung ihrer noch offenen Abhängigkeiten erzeugt und sind damit **ahead-derived** im Sinne von Plan §13.6: `AI6-012` fehlt `AI6-011`; `AI6-013` fehlt `AI6-012`; `AI6-014` fehlt `AI6-013`; `AI6-015` fehlen `AI6-013` und `AI6-014`; `AI6-016` fehlen `AI6-011` und `AI6-015`; `AI6-017` fehlen `AI6-013`, `AI6-014`, `AI6-015` und `AI6-016`. Jede fehlende Voraussetzung ist ein bereits in Plan §15 definierter Blueprint der eigenen `depends_on`-Liste. Ihre `## Context`-Abschnitte benennen die noch fehlenden Pfade samt erzeugendem Ticket, ihre `## Notes` tragen die Rebase-Verpflichtung, und ihre `existing`-Marker bezeichnen die Runbasis nach dem Landen der `depends_on`-Tickets. Bis zum durchgeführten Rebase bleiben sie auf `status: todo` und dürfen weder freigegeben noch beansprucht werden. Diese Ableitungen haben keinen Status verändert; Statusänderungen bleiben getrennte menschliche Entscheidungen.

## 3. Backlog

Stand der abgeleiteten Ansicht: 13. August 2026, abgeleitet aus Planrevision V1.7.1 und dem vorhandenen Dateibestand.
