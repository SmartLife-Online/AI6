...
final class RuntimeDocumentationTest extends TestCase
{
    ...
    public function test_readme_documents_start_roles_allowlists_versions_and_commands(): void
    {
        ...
        foreach ([
            ...
            '`target_control_oid`',
            'Remotes im SHA-1- und SHA-256-Objektformat nebeneinander',
            'Objektformat-Upgrade erfolgt bei ruhendem Betrieb',
            'alte und neue Writer dürfen nicht gleichzeitig schreiben',
            'Projektseite neu laden und über **Clone starten** eine neue Operation anfordern',
            'Die frühere Operations-ID bleibt idempotent und ihr Fehlernachweis lesbar',
