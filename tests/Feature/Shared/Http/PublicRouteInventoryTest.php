...
final class PublicRouteInventoryTest extends TestCase
{
    ...
    public function test_the_public_route_inventory_is_exactly_pinned(): void
    {
        ...
        self::assertSame([
            ...
            'GET /projects/{project}/human-requests/{requestId} [web, auth, can:answerHumanRequest,project]',
            'GET /projects/{project}/operations/{operation} [web, auth, can:view,project]',
            'GET /projects/{project}/queue [web, auth, can:view,project]',
            'GET /projects/{project}/runs/{runId} [web, auth, can:viewRun,project]',
            'GET /projects/{project}/runs/{runId}/artifacts/{artifactId} [web, auth, can:viewRun,project]',
            ...
            'POST /projects/{project}/queue/{approvalId}/enqueue [web, auth, can:startRun,project]',
            'POST /projects/{project}/queue/{approvalId}/remove [web, auth, can:startRun,project]',
