...
final class AuthorizationMatrixTest extends TestCase
{
    public function test_project_role_enum_and_action_enum_are_exact(): void
    {
        ...
        self::assertSame(
            ['appear_in_list', 'view_details', 'refresh_read_model', 'edit_ticket', 'change_ticket_status', 'refresh_configuration', 'approve_configuration', 'approve_ticket', 'start_run', 'view_run', 'answer_human_request'],
