...
final class ScaffoldStructureTest extends TestCase
{
    ...
    public function test_ai6_modules_contain_only_the_approved_files_through_ai6_040(): void
    {
        ...
        self::assertSame([
            ...
            'app/AI6/Agents/AgentCapabilityPending.php',
            ...
            'app/AI6/Agents/CodexCliAdapter.php',
            'app/AI6/Agents/CodexCliConfiguration.php',
            'app/AI6/Agents/Console/ProviderCommand.php',
            ...
            'app/AI6/Agents/ProviderBinaryDigest.php',
            'app/AI6/Agents/ProviderCapabilityPublisher.php',
            'app/AI6/Agents/ProviderCapabilityReport.php',
            'app/AI6/Agents/ProviderCredentialStore.php',
            'app/AI6/Agents/ProviderLogin.php',
            'app/AI6/Agents/ProviderOnboarding.php',
            ...
            'app/AI6/Checks/BoundCheckProfiles.php',
            ...
            'app/AI6/Git/CandidateProvenancePreflight.php',
            ...
            'app/AI6/Git/PublishCandidateService.php',
            ...
            'app/AI6/Git/RunBlobSizeLimitExceeded.php',
            ...
            'app/AI6/HumanLoop/GateEvidenceHumanRequestBinding.php',
            'app/AI6/HumanLoop/GateEvidenceService.php',
            ...
            'app/AI6/Runs/ApprovalClaimStarter.php',
            'app/AI6/Runs/ApprovalFreshness.php',
            'app/AI6/Runs/ApprovalLimits.php',
            'app/AI6/Runs/ApprovalQueue.php',
            'app/AI6/Runs/ApprovalQueueConflict.php',
            'app/AI6/Runs/ApprovalQueueController.php',
            'app/AI6/Runs/ApprovalQueueState.php',
            ...
            'app/AI6/Runs/CandidateGate.php',
            ...
            'app/AI6/Runs/ProjectQueueController.php',
            'app/AI6/Runs/PublishCompletionService.php',
            'app/AI6/Runs/QueueAutoStarter.php',
            'app/AI6/Runs/QueueEligibility.php',
            'app/AI6/Runs/QueueEligibilityDecision.php',
            'app/AI6/Runs/QueueReevaluation.php',
            'app/AI6/Runs/QueueReevaluationTrigger.php',
            ...
            'app/AI6/Runs/RetentionCategory.php',
            'app/AI6/Runs/RetentionLimit.php',
            'app/AI6/Runs/RetentionPolicy.php',
            ...
            'app/AI6/Runs/RunArtifactDownloadController.php',
            'app/AI6/Runs/RunArtifactKind.php',
            'app/AI6/Runs/RunArtifactRetentionState.php',
            ...
            'app/AI6/Shared/Doctor/CodexCliDoctorCheck.php',
            ...
            'app/AI6/Tickets/TicketDependencyEligibility.php',
